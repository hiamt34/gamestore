      ...
      <div class="row">
          ...
          <div class="footer__navs">
            ...
            <div class="footer__nav footer__nav--3">
              ...
              <div class="footer__contacts">
                <a
                  class="footer__link"
                  href="tel:+18092345678"
                >+1 809 234-56-78</a>
                <a
                  class="footer__link"
                  href="mailto:codetoanbug06@gamil.com"
                >codetoanbug06@gamil.com</a>
                ...
                <div class="footer__social">
                  ...
                  >
                    ...
                    />
                    <path d="M320 143h48v129h-48zM208 143h48v129h-48z" /></svg></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-12">
          <div class="footer__wrap">
            <nuxt-link class="footer__logo" to="/products">
              <img src="~/assets/img/logo.png" alt="">
            </nuxt-link>

            <span
              class="footer__copyright"
            >© Trần Thanh Hà, 2021—2022 <br>
              Create by
              <a
                href="https://www.facebook.com/profile.php?id=100047428539037"
                target="_blank"
              >Codetoanbug06@gmail.com</a></span>
          </div>
        </div>
      </div>
    </div>
